...
button_add = Button(win, text="+", padx=39, pady=20, command=lambda: button_click(0))
button_equal = Button(win, text="=", padx=91, pady=20, command=lambda: button_click(0))
button_clear = Button(win, text="Clear", padx=79, pady=20, command=clear)
